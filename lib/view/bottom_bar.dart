...
import 'package:velorant/controller/bottom_controller.dart';
import 'package:velorant/view/2.map/mode_screen.dart';
import 'package:velorant/view/utils/color.dart';
import 'package:velorant/view/utils/text.dart';
      ...
      drawer: Drawer(
        ...
        child: Column(
          children: [
            ...
            commonListTile(() {}, Icons.star, 'Rate Us'),
            Divider(
                thickness: 1, indent: height * 0.01, endIndent: height * 0.01),
            commonListTile(() {}, Icons.rate_review, 'Review Us'),
            Divider(
                thickness: 1, indent: height * 0.01, endIndent: height * 0.01),
            commonListTile(() {}, Icons.privacy_tip, 'Privacy Policy'),
            Divider(
                thickness: 1, indent: height * 0.01, endIndent: height * 0.01),
