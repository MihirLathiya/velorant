...
import 'package:velorant/controller/weapon_controller.dart';
import 'package:velorant/model/weapon_model.dart';
import 'package:velorant/view/3.weapon/weapon_detail_screen.dart';
import 'package:velorant/view/utils/color.dart';
import 'package:velorant/view/utils/image.dart';
            ...
            return MasonryGridView.count(
              ...
              itemBuilder: (context, index) {
                return GestureDetector(
                  ...
                  child: Hero(
                    tag: '${weaponResponseModel.data![index].displayName}',
                    child: Container(
                      height: height * 0.2,
                      width: width * 0.2,
